...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
								...
								<div class="topbar-item">
									<div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
										...
										<span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
											<span class="symbol-label font-size-h5 font-weight-bold">{{Auth::user()->first_name[0]}}</span>
										</span>
									</div>
								</div>
								<!--end::User-->
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="http://teacoders.in" target="_blank" class="text-dark-75 text-hover-primary">TeaCoders</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
							<div class="nav nav-dark">
								<a href="http://teacoders.in" target="_blank" class="nav-link pl-0 pr-5">About</a>
								<a href="http://teacoders.in" target="_blank" class="nav-link pl-0 pr-5">Team</a>
								<a href="http://teacoders.in" target="_blank" class="nav-link pl-0 pr-0">Contact</a>
							</div>
							<!--end::Nav-->
						</div>
						<!--end::Container-->
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<div class="symbol-label" style="background-image:url(/storage/user/avatar/{{Auth::user()->avatar}})"></div>
						<i class="symbol-badge bg-success"></i>
					</div>
					<div class="d-flex flex-column">
						<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{Auth::user()->first_name}}</a>
						<div class="text-muted mt-1">{{Auth::user()->roles[0]->display_name ?? 'ADmin'}}</div>
						<div class="navi mt-2">
							<a href="#" class="navi-item">
                            ...
                            <a class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5" href="{{ url('/logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                Sign Out
                            </a>
				...
				<div class="navi navi-spacer-x-0 p-0">
					<!--begin::Item-->
					<a href="/profile_update" class="navi-item">
						<div class="navi-link">
		...
		<script>var HOST_URL = "https://teacoders.in";</script>
		...
		<script src="assets/backend/plugins/custom/gmaps/gmaps.js"></script>
		<!--end::Page Vendors-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="assets/backend/js/pages/widgets.js"></script>
		<script src="assets/backend/js/pages/crud/forms/widgets/form-repeater.js?v=7.0.6">
        </script>
        <!--begin::Page Vendors(used by this page)-->
        <script src="assets/backend/plugins/custom/datatables/datatables.bundle.js?v=7.0.6">
        </script>
        <script src="assets/backend/js/pages/crud/datatables/extensions/buttons.js?v=7.0.6">
        </script>
        <!--end::Page Vendors-->
        <script src="assets/backend/js/pages/crud/forms/widgets/bootstrap-datepicker.js?v=7.0.6">
        </script>
        <!--begin::Page Scripts(used by this page)-->
		<!--end::Page Scripts-->
