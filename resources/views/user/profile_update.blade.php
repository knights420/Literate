            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <h5 class="font-weight-bold mb-6">User Profile</h5>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label">Avatar</label>
                    {{-- <img src="{{Storage::url('public/user/avatar/'.Auth::user()->avatar)}}" alt=""> --}}
                    <div class="col-lg-9 col-xl-6">
                        <div class="image-input image-input-outline" id="kt_profile_avatar" style="background-image: url(assets/media/users/blank.png)">
                            <div class="image-input-wrapper" style="background-image: url(/storage/user/avatar/{{Auth::user()->avatar}})"></div>
